...
const QMap<QString, DiagnosticInfo>& diagTable() {
    static const QMap<QString, DiagnosticInfo> table = {
        ...
        {QStringLiteral("P008"), {"Unknown subchain argument key", "warning", "parser"}},
        {QStringLiteral("P009"), {"Duplicate subchain argument key", "warning", "parser"}},
        {QStringLiteral("P010"), {"Missing ',' between subchain arguments", "warning", "parser"}},
